# py_light/image/train_image_mobilenet_v3.py
...
OUTPUT_DIR = "outputs_light/image_mobilenet_v3"
...
model.classifier[-1] = nn.Linear(in_features, len(label_to_idx))
...
for epoch in range(EPOCHS):
    model.train()
    pbar = tqdm(train_loader, desc=f"[MobileNetV3] Epoch {epoch+1}/{EPOCHS}")
